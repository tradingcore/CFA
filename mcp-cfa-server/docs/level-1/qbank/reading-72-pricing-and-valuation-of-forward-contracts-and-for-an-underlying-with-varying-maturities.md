---
title: "Reading 72 Pricing and Valuation of Forward Contracts and for an Underlying with Varying Maturities"
source_pdf: "Reading 72 Pricing and Valuation of Forward Contracts and for an Underlying with Varying Maturities.pdf"
converter: "mistral-ocr-latest"
date_converted: "2026-05-07T00:12:34Z"
pages: 2
...
B) exchange a floating-rate obligation for a fixed-rate obligation.
...
B) typically zero at initiation.
C) equal to the spot price at expiration.
...
A) $V_{t} = F_{0}(T) - S_{t}(1 + Rf)^{-(T - t)}$.

B) $V_{t} = (S_{t} - F_{0}(T))(1 + Rf)^{-(T - t)}$.

C) $V_{t} = S_{t} - F_{0}(T)(1 + Rf)^{-(T - t)}$.
